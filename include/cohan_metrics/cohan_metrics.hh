...
#define default_segment_ cohan_msgs::TrackedSegmentType::HEAD
...
public:
  Metrics(std::string odom_topic, std::string agents_topic,
          std::string log_name);
